...
#SBATCH --output=rna_protein_train_%j.out
#SBATCH --error=rna_protein_train_%j.err
...
# Run training
echo "Starting RNA-Protein Interaction Training..."
...
echo "Results saved to: outputs_RPI1807/"
